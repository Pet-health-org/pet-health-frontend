...
import { getVacunas, createVacuna, getVacunasByMascota } from '../../../services/vacunas.service';
...
export function useVaccines() {
  ...
  const getPetVaccinations = async (petId: string) => {
    try {
      const response = await getVacunasByMascota(petId);
