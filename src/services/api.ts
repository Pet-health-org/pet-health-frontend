...
export const updateHistoriaClinica = (id: any, data: any) => api.patch(`/historias-clinicas/${id}`, data);
...
export const updateMascota = (id: any, data: any) => api.patch(`/mascotas/${id}`, data);
export const deleteMascota = (id: any) => api.delete(`/mascotas/${id}`);
export const getMascotasByDueno = (duenoId: any) => api.get(`/mascotas/propietario/${duenoId}`);
...
export const getVacunasByHistoriaClinica = (historiaId: any) => api.get(`/vacunas/historia/${historiaId}`);
...
export const markNotificacionAsRead = (id: any) => api.patch(`/notificaciones/${id}`, { leida: true });
